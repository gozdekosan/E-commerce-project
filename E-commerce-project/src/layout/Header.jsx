...
export default function Header() {
  ...
  const UserAuthSection = () => (
    <>
      {isLoggedIn ? (
        <div className="flex items-center space-x-2 text-[#23A6F0]">
          <Gravatar 
              email={user.email} 
              size={24} 
              default="identicon" 
          ...
          />
          <span className="text-sm font-bold text-[#252B42]">{userName}</span>
        </div>
      ) : (
        ...
        <div className="w-full bg-[#252B42] text-white text-xs sm:text-sm h-14 flex justify-center items-center px-4">
          <div className="max-w-7xl w-full flex justify-between items-center">
            ...
            <div className="flex gap-6 items-center">
              ...
              <span className="hidden md:flex gap-2 font-semibold items-center">
                <Mail size={16} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[4rem] flex justify-between items-center relative">
            ...
            <ul className="hidden lg:flex gap-6 items-center text-sm font-bold text-[#737373]">
              ...
              >
                ...
                {shopOpen && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white shadow-lg w-[23rem] h-[14rem] z-50 px-6 py-6 border border-gray-100">
            ...
            <div className="hidden lg:flex items-center gap-6 text-[#23A6F0]">
              ...
              <div className="relative">
                <button 
                    ...
                    className="flex items-center gap-1 hover:opacity-80 relative"
                >
                    <ShoppingCart size={16} strokeWidth={2.5} />
                    <span className="text-xs font-normal">{cartItemCount}</span>
                </button>
                
                <CartDropdown 
                    isVisible={isCartDropdownOpen} 
                    toggleVisibility={() => setIsCartDropdownOpen(false)}
                />
              </div>
            ...
            <div className="flex items-center gap-4 lg:hidden text-[#23A6F0]">
