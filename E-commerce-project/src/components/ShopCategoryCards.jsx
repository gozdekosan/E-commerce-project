      ...
      <div className="max-w-[71.25rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex justify-between items-center mb-8 flex-wrap gap-4">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-[#737373] text-sm">Views:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-8 md:gap-x-8 md:gap-y-12">
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          <nav className="flex space-x-1" aria-label="Pagination">
            <button className="px-4 py-3 text-[#BDBDBD] border border-[#E8E8E8] rounded-md font-bold hover:bg-gray-100 transition text-sm">
              First
            </button>
            <button className="px-4 py-3 text-white bg-[#23A6F0] border border-[#23A6F0] rounded-md font-bold text-sm">
              1
            </button>
            <button className="px-4 py-3 text-[#23A6F0] border border-[#E8E8E8] rounded-md font-bold hover:bg-gray-100 transition text-sm">
              2
            </button>
            <button className="px-4 py-3 text-[#23A6F0] border border-[#E8E8E8] rounded-md font-bold hover:bg-gray-100 transition text-sm">
              3
