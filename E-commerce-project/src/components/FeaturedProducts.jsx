  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="text-center px-6 pt-6 pb-9">
        <h3 className="text-base font-bold text-[#252B42] mb-2.5" style={{ fontFamily: 'Montserrat' }}>
          Graphic Design
        </h3>

        <p className="text-sm font-bold text-[#737373] mb-2.5" style={{ fontFamily: 'Montserrat' }}>
          English Department
        </p>

        <div className="flex justify-center items-center gap-2 mb-2.5">
          <span className="text-base font-bold text-[#BDBDBD]" style={{ fontFamily: 'Montserrat' }}>
            $16.48
          </span>
          <span className="text-base font-bold text-[#23856D]" style={{ fontFamily: 'Montserrat' }}>
            $6.48
          </span>
        </div>
  ...
  return (
    <section className="py-20 bg-white">
      <div className="text-center mb-12 px-6">
        <h3 className="text-xl text-[#737373] mb-2.5" style={{ fontFamily: 'Montserrat' }}>
          Featured Products
        </h3>
        <h2 className="text-2xl font-bold text-[#252B42] mb-2.5" style={{ fontFamily: 'Montserrat' }}>
          BESTSELLER PRODUCTS
        </h2>
        <p className="text-sm text-[#737373]" style={{ fontFamily: 'Montserrat' }}>
